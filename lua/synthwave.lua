...
local syntax = {
  Normal = { fg = z.fg, bg = z.none },
  Terminal = { fg = z.fg, bg = z.none },
  SignColumn = { fg = z.fg, bg = z.none },
  FoldColumn = { fg = z.fg_alt, bg = z.none },
  VertSplit = { fg = z.black, bg = z.none },
  ...
  NormalFloat = { fg = z.base8, bg = z.none },
  FloatBorder = { bg = z.none },
